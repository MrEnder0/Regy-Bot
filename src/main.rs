...
async fn user(ctx: &Context, msg: &Message) -> CommandResult {
    ...
    if arg == "none" {
        ...
        msg.reply(ctx, "Regy is a Discord regex automoderation bot developed mainly by Mr.Ender#0001 with a few contributions by 3kh0#0001 and 1984#0001. Profile picture created by 1984").await?);
